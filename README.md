...
![MigasaUML](https://github.com/user-attachments/assets/d978331d-b18d-4fcc-89f4-22994cc18d4b)
...
| **T-05** | Instalación tema Green Store | Descargar, instalar, activar | Iluminada | Done | T-01, T-04 | Guardar licencia segura |
| **T-06** | Configurar colores corporativos | Aplicar RGB Pantone (#A3AB11, #7C9323, #3B593B) en Theme Customizer | Iluminada | Done | T-05 | Usar manual identidad |
| **T-07** | Cargar tipografías | Subir DIN Black y Myriad Pro | Iluminada | Done | T-04 | Formato web (WOFF2) |
...
| **T-12** | Instalar y configurar Wordfence | Activar firewall, configurar 2FA, programar escaneos | ------ | To Do | T-01, T-08 | Learning mode inicial |
| **T-13** | Instalar y configurar Autoptimize | Activar cache, lazy load, minificación CSS/JS | ------ | To Do | T-01, T-09 | Limpiar cache tras cambios |
| **T-14** | Instalar y configurar Yoast SEO | Configurar sitemap, schema Organization, breadcrumbs | ------ | To Do | T-01, T-10 | Palabra clave: aceite oliva |
| **T-15** | Instalar y configurar MonsterInsights | Conectar con cuenta GA4, activar tracking formularios | ------ | To Do | T-01, T-11 | Crear cuenta GA4 previa |
...
| **T-28** | Crear formulario contacto | WPForms: campos, validación, notificaciones, GDPR | Iluminada | Done | T-16, T-22 | Testing envío real |
| **T-29** | Crear página Contacto | Formulario + datos corporativos | Iluminada | Done | T-04, T-28 | 2 ubicaciones en mapa |
| **T-30** | Optimizar imágenes | Comprimir todas, convertir a WebP, añadir ALT | ------ | To Do | T-23, T-24, T-26 | ShortPixel bulk |
| **T-31** | Configurar UpdraftPlus | Backup semanal automático a Google Drive | ------ | To Do | T-22 | Retener 4 copias |
| **T-32** | Testing responsive | Probar en iPhone, Android, iPad, diferentes resoluciones | ------ | To Do | T-22 a T-29 | Chrome DevTools + real |
| **T-33** | Testing formularios | Envíos de prueba, validaciones, emails recibidos | Iluminada | Done | T-28, T-29 | Verificar anti-spam |
| **T-34** | Documentar implementación | Screenshots de cada página, descripciones detalladas | Iluminada | Done | T-23 a T-29 | Para entregable PDF |
| **T-35** | Documentar análisis | UML y glosario | Guillermo | Done | T-21 | Para entregable PDF |
| **T-36** | Documentar REM | Objetivos y requisitos | Emilio | Done | Todos los requisitos (punto 3) | Para entregable PDF |
| **T-37** | Documentar plugins | Tablas comparativas plugins y explicación plugin elegido | Nazaret | Done | T-08 a T-10 | Para entregable PDF |
| **T-38** | Documentar mockups | Mockups con sus descripciones | Nazaret | Done | T-17 a T-20 | Para entregable PDF |
| **T-39** | Documentar product backlog | Tabla product backlog | Iluminada | Done | PBl-01 a PBl-15 | Para entregable PDF |
| **T-40** | Documentar sprint backlog | Tabla sprint backlog | Guillermo e Iluminada | Done | T-01 a T-43 | Para entregable PDF |
| **T-41** | Documentar burndown chart | Gráfico burndown | Iluminada | Done | Horas totales reales | Para entregable PDF |
| **T-42** | Revisar identidad corporativa | Verificar colores Pantone, tipografías, logo correcto | ------ | To Do | Todas anteriores | Checklist manual |
| **T-43** | Ajustes finales y pulido | Corregir detalles, alinear elementos, spacing | ------ | To Do | Todas anteriores | QA final |
