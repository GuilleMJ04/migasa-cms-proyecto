...
| **PBl-11** | Como usuario, quiero poder autenticarme | Formulario de Log In, registro y recuperación de contraseña  |•  <br>• Tokenización sin almacenar datos de tarjeta.<br>• Confirmación de pedido por email. | Alta | 2 | Sprint 1 |
