...
| Información corporativa | Esto es lo que nos define como empresa a nivel visual e institucional. Va el logo de MIGASA y de las dos marcas (Ybarra y La Masía) en todos los formatos posibles, los colores corporativos con sus códigos exactos, la guía de estilo completa en PDF para descargar... También nuestra historia desde 1941, los valores que nos mueven, la estructura de la empresa, quién forma el equipo directivo, y algunas cifras clave como cuánta gente trabaja aquí o en cuántos países estamos. Es la sección más "institucional" del portal. |
