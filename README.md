...
| **RI08: Contacto y ubicaciones** | El sitio incluirá un apartado de contacto con información corporativa actualizada: teléfonos, direcciones de correo electrónico, formulario de contacto estructurado y mapa de las sedes principales. También se añadirán enlaces a las redes sociales oficiales del grupo. |
...
|----------------------|-------------|
| **RUI01:** Interfaz intuitiva y modular| La web debe contar con una interfaz sencilla e intuitiva, organizada por bloques, que facilite la gestión del contenido. Los botones y enlaces deben ser visibles y atractivos, de forma que cualquier usuario pueda moverse por la página sin dificultad. |
